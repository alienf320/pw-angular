...
export class BoxService {
  ...
  getCurrentBoxId(): string {
    return this.currentBox.value._id!;
  }
  ...
  savePokemon(
    ...
    return this.http.post(this.baseUrl + '/add-pokemon', {
      displayName: pokemon,
      ...pokemonData,
      boxId: boxId,
    });
  ...
  movePokemonToBox(destinationBox: Box, pokemon: myPokemon)  {
    return this.http.put<Box>(this.baseUrl + '/move-pokemon', {
      sourceBoxId: this.currentBox.value._id,
      destinationBoxId: destinationBox._id,
