export const ABILITIES = [
  ...
  },
  {
    ...
    description: '"prevents infatuation, less dmg from heart moves."',
  },
  {
    id: 13,
    name: 'cloudnine',
  ...
  },
  {
    ...
    description: '"increases accuracy and lowers damage from dark moves."',
  },
  {
    id: 36,
    name: 'trace',
  ...
  },
  {
    ...
    description: '"prevents flinching, raises their crit chance."',
  },
  {
    id: 40,
    name: 'magmaarmor',
    displayName: 'magma armor',
    description: '"prevents frz. powers fire+magma. less dmg frm ice."',
  },
  {
    id: 41,
    name: 'waterveil',
    displayName: 'water veil',
    description: '"prevents burn. boosts water moves. less dmg frm fire."',
  },
  {
    id: 42,
    name: 'magnetpull',
  ...
  },
  {
    ...
    description: '"may burn the attacker on contact, more dmg to burned foes."',
  },
  {
    id: 50,
    name: 'runaway',
    ...
    description:
      '"sure escape from wild pokes, gives priority to switch-out moves."',
  },
  {
    id: 51,
    name: 'keeneye',
    displayName: 'keen eye',
    description: '"accuary is slightly raised and cannot be lowered."',
  },
  {
    id: 52,
    name: 'hypercutter',
    displayName: 'hyper cutter',
    description: '"prevents atk drops. boosts sword moves."',
  },
  {
    id: 53,
    name: 'pickup',
    displayName: 'pickup',
    description: '"the pokémon may pick up items, boosts the power of fling."',
  },
  {
    id: 54,
    name: 'truant',
  ...
  },
  {
    ...
    name: 'hustle',
    displayName: 'hustle',
    description: '"boosts atk and spatk, but lowers accuracy."',
  },
  {
    id: 56,
    name: 'cutecharm',
    displayName: 'cute charm',
    description: '"contact may infatuate the foe, boosts dmg of heart moves"',
  },
  {
    id: 57,
    name: 'plus',
    displayName: 'plus',
    description: '"ups offenses if another pokémon has plus or minus."',
  },
  {
    id: 58,
    name: 'minus',
  ...
  },
  {
    ...
    description: '"protects from item theft, boosts moves that steal items"',
  },
  {
    id: 61,
    name: 'shedskin',
  ...
  },
  {
    id: 72,
    name: 'darklife',
    displayName: 'dark life',
    description: '"heals during midnight."',
  },
  {
    id: 73,
    name: 'whitesmoke',
  ...
  },
  {
    ...
    name: 'memetic',
    displayName: 'memetic',
    description: '"contact spreads this ability. lwrs stats non-meme types."',
  },
  {
    id: 75,
    name: 'merciless',
    displayName: 'merciless',
    description: '"always crits a poisoned target."',
  },
  {
    id: 76,
    name: 'isolation',
    displayName: 'isolation',
    description: '"reduces the damage of incoming special moves."',
  },
  {
    id: 77,
    name: 'tangledfeet',
  ...
  },
  {
    ...
    description: '"maxes atk when taking a crit, boosts dmg of rage moves"',
  },
  {
    id: 84,
    name: 'unburden',
  ...
  },
  {
    ...
    description: '"weakens the power of fire and magma moves."',
  },
  {
    id: 86,
    name: 'simple',
  ...
  },
  {
    ...
    description: '"restores hp in acid rain."',
  },
  {
    id: 91,
    name: 'adaptability',
  ...
  },
  {
    ...
    name: 'stall',
    displayName: 'polite',
    description: '"moves after all pokemon, but increases stab."',
  },
  {
    id: 101,
    name: 'technician',
  ...
  },
  {
    ...
    displayName: 'klutz',
    description:
      '"prevents use of held items, boosts dmg if not holding an item"',
  },
  {
    id: 104,
    name: 'moldbreaker',
  ...
  },
  {
    ...
    description:
      '"heightens the critical ratios, makes every attack drop money."',
  },
  {
    id: 106,
    name: 'aftermath',
  ...
  },
  {
    ...
    description: '"reduces dmg taken if moves last"',
  },
  {
    id: 109,
    name: 'unaware',
  ...
  },
  {
    ...
    name: 'filter',
    displayName: 'filter',
    description: '"reduces damage from supereffective attacks."',
  },
  {
    id: 112,
    name: 'slowstart',
  ...
  },
  {
    ...
    name: 'scrappy',
    displayName: 'scrappy',
    description: '"ignores type immunities."',
  },
  {
    id: 114,
    name: 'stormdrain',
  ...
  },
  {
    ...
    description: '"the pokémon makes it acid rain if it appears in battle."',
  },
  {
    id: 117,
    name: 'snowwarning',
  ...
  },
  {
    ...
    description: '"boosts dmg against grass types"',
  },
  {
    id: 119,
    name: 'frisk',
  ...
  },
  {
    ...
    displayName: 'unnerve',
    description:
      '"makes the foe nervous and unable to eat berries, boosts fear moves"',
  },
  {
    id: 128,
    name: 'defiant',
  ...
  },
  {
    ...
    description: '"may disable an opponent move, boosts ghost moves"',
  },
  {
    id: 131,
    name: 'healer',
  ...
  },
  {
    ...
    description: '"less dmg to allies, friendship to the trainer boosts dmg"',
  },
  {
    id: 133,
    name: 'weakarmor',
  ...
  },
  {
    ...
    description: '"immune to contact moves."',
  },
  {
    id: 136,
    name: 'multiscale',
  ...
  },
  {
    ...
    description: '"powers up attacks when poisoned."',
  },
  {
    id: 138,
    name: 'flareboost',
  ...
  },
  {
    ...
    description: '"dodges allies attack, raises psychic moves accuracy"',
  },
  {
    id: 141,
    name: 'moody',
  ...
  },
  {
    ...
    description: '"defense can\'t be lowered. powers up peck moves."',
  },
  {
    id: 146,
    name: 'sandrush',
  ...
  },
  {
    ...
    name: 'mozart',
    displayName: 'mozart',
    description: '"could mozart still be alive?"',
  },
  {
    id: 150,
    name: 'imposter',
  ...
  },
  {
    ...
    description:
      '"ups atk when hit by a dark-type move, more dmg to dark types."',
  },
  {
    id: 155,
    name: 'rattled',
  ...
  },
  {
    ...
    name: 'pride',
    displayName: 'pride',
    description: '"raises special attack when you defeat a pokemon."',
  },
  {
    id: 161,
    name: 'zenmode',
  ...
  },
  {
    ...
    name: 'pounce',
    displayName: 'pounce',
    description: '"goes first on the first turn."',
  },
  {
    id: 165,
    name: 'aerilate',
  ...
  },
  {
    ...
    description:
      '"protects allies from status attacks, heals status problems if grassy terrain is up"',
  },
  {
    id: 167,
    name: 'aurabreak',
  ...
  },
  {
    ...
    name: 'berserk',
    displayName: 'berserk',
    description: '"increases spatk when hit"',
  },
  {
    id: 170,
    name: 'competitive',
  ...
  },
  {
    ...
    description:
      '"halves special dmg to grounded pokemon if grassy terrain is up"',
  },
  {
    id: 174,
    name: 'furcoat',
  ...
  },
  {
    ...
    description: '"boosts the defense stat when the terrain is grass."',
  },
  {
    id: 178,
    name: 'magician',
  ...
  },
  {
    ...
    description: '"prevents ally pokémon from falling asleep."',
  },
  {
    id: 187,
    name: 'vespertine',
    displayName: 'vespertine',
    description: '"boosts the pokémon\'s speed in midnight."',
  },
  {
    id: 188,
    name: 'toughclaws',
  ...
  },
  {
    id: 190,
    name: 'acidrush',
    displayName: 'acid rush',
    description: '"raises speed in acid rain."',
  },
  {
    id: 191,
    name: 'headache',
    displayName: 'headache',
    description: '"user\'s spatk rises while confused."',
  },
  {
    id: 192,
    name: 'windate',
    displayName: 'windate',
    description: '"normal-type moves become wind-type moves."',
  },
  {
    id: 193,
    name: 'turbine',
    displayName: 'turbine',
    description: '"draws in all wind-type moves to up sp. attack."',
  },
  {
    id: 194,
    name: 'immolate',
    displayName: 'immolate',
    description: '"normal-type moves become fire-type moves."',
  },
  {
    id: 195,
    name: 'sunbathe',
    displayName: 'sunbathe',
    description: '"the pokémon gradually regains hp in sun."',
  },
  {
    id: 196,
    name: 'snowrush',
    displayName: 'snow rush',
    description: '"boosts the pokémon\'s speed in hail."',
  },
  {
    id: 197,
    name: 'magicate',
    displayName: 'magicate',
    description: '"normal-type moves become magic-type moves."',
  },
  {
    id: 198,
    name: 'oasis',
    displayName: 'oasis',
    description: '"the pokémon gradually regains hp in sandstorms."',
  },
  {
    id: 199,
    name: 'winterforce',
    displayName: 'winter force',
    description: '"boosts certain moves\' power in hail."',
  },
  {
    id: 200,
    name: 'steamengine',
    displayName: 'steam engine',
    description: '"raise speed if hit by water, fire, steam."',
  },
  {
    id: 201,
    name: 'evaporate',
    displayName: 'evaporate',
    description: '"normal-type moves become steam-type moves."',
  },
  {
    id: 202,
    name: 'berserker',
    displayName: 'berserker',
    description: '"raises attack when hit."',
  },
  {
    id: 203,
    name: 'martialate',
    displayName: 'martialate',
    description: '"normal-type moves become fighting-type moves."',
  },
  {
    id: 204,
    name: 'machinate',
    displayName: 'machinate',
    description: '"normal-type moves become steel-type moves."',
  },
  {
    id: 205,
    name: 'furiousfeet',
    displayName: 'furious feet',
    description: '"boosts the power of kicking moves."',
  },
  {
    id: 206,
    name: 'thicktail',
    displayName: 'thick tail',
    description: '"boosts the power of tail moves."',
  },
  {
    id: 207,
    name: 'constrictor',
    displayName: 'constrictor',
    description: '"boosts the power of trapping moves."',
  },
  {
    id: 208,
    name: 'sceptic',
    displayName: 'skeptic',
    description: '"ups resistance to fairy, divine and magic-type moves."',
  },
  {
    id: 209,
    name: 'beastboost',
    displayName: 'beast boost',
    description: '"raises highest stat when defeat pokemon."',
  },
  {
    id: 210,
    name: 'coldblooded',
    displayName: 'cold blooded',
    description: '"reduces hp if it is cold. fire restores hp."',
  },
  {
    id: 211,
    name: 'lodestone',
    displayName: 'lodestone',
    description: '"raises defense if hit by a steel-type move."',
  },
  {
    id: 212,
    name: 'vaporize',
    displayName: 'vaporize',
    description: '"raises sp.def if hit by a water-type move."',
  },
  {
    id: 213,
    name: 'breakdown',
    displayName: 'breakdown',
    description: '"maxes spatk after taking a critical hit."',
  },
  {
    id: 214,
    name: 'firewall',
    displayName: 'firewall',
    description: '"adjusts defenses according to a foe\'s offenses."',
  },
  {
    id: 215,
    name: 'focus',
    displayName: 'focus',
    description: '"boosts spatk if there is a status problem."',
  },
  {
    id: 216,
    name: 'shadowcall',
    displayName: 'shadow call',
    description: '"brings up midnight weather."',
  },
  {
    id: 217,
    name: 'stamina',
    displayName: 'stamina',
    description: '"raises defense when hit."',
  },
  {
    id: 218,
    name: 'wacky',
    displayName: 'wacky',
    description: '"makes all moves wack."',
  },
  {
    id: 219,
    name: 'hydrate',
  ...
  },
  {
    ...
    description: '"raises speed if hit by a food-type move."',
  },
  {
    id: 221,
    name: 'vacuum',
    displayName: 'vacuum',
    description: '"draws in all wind and flying-type moves to up defense."',
  },
  {
    id: 222,
    name: 'solarforce',
    displayName: 'solar force',
    description: '"boosts certain moves\' power in sun."',
  },
  {
    id: 223,
    name: 'ionate',
    displayName: 'ionate',
    description: '"normal-type moves become electric-type moves."',
  },
  {
    id: 224,
    name: 'graze',
    displayName: 'graze',
    description: '"the pokémon gradually regains hp."',
  },
  {
    id: 225,
    name: 'pro',
    displayName: 'pro',
    description: '"slightly boosts the power of supereffective moves."',
  },
  {
    id: 226,
    name: 'builder',
    displayName: 'builder',
    description: '"extends the duration of barrier and room moves."',
  },
  {
    id: 227,
    name: 'siphon',
    displayName: 'siphon',
    description: '"boosts the power of draining moves."',
  },
  {
    id: 228,
    name: 'bellows',
    displayName: 'bellows',
    description: '"wind moves power up this pokemon\'s fire moves."',
  },
  {
    id: 229,
    name: 'sadist',
    displayName: 'sadist',
    description: '"hp is restored a little every time it inflicts damage."',
  },
  {
    id: 230,
    name: 'metalworker',
    displayName: 'metalworker',
  ...
  },
  {
    ...
    description: '"boosts the power of sound based moves."',
  },
  {
    id: 232,
    name: 'drumroll',
    displayName: 'drum roll',
    description: '"boosts moves used consecutively and sound based moves."',
  },
  {
    id: 233,
    name: 'explosive',
    displayName: 'explosive',
    description: '"boosts the power of self destructing moves."',
  },
  {
    id: 234,
    name: 'dreamcatcher',
    displayName: 'dreamcatcher',
    description: '"draws in all psychic-type moves to up sp. attack."',
  },
  {
    id: 235,
    name: 'irradiated',
    displayName: 'irradiated',
    description: '"reduces a poisoned foe\'s hp."',
  },
  {
    id: 236,
    name: 'safeshield',
    displayName: 'safe shield',
    description: '"sets up safeguard."',
  },
  {
    id: 237,
    name: 'choicepower',
    displayName: 'choice power',
    description: '"powers up moves but can only choose one."',
  },
  {
    id: 238,
    name: 'cactus',
    displayName: 'cactus',
    description:
      '"the pokémon receives benefits in rain/sandstorm and inflicts damage on contact."',
  },
  {
    id: 239,
    name: 'balance',
    displayName: 'balance',
    description:
      '"this pokemon\'s not very effective moves are boosted and super effective moves against it are decreased."',
  },
  {
    id: 240,
    name: 'vastknowledge',
    displayName: 'vast knowledge',
    description: '"raises the pokémon\'s spatk stat."',
  },
  {
    id: 241,
    name: 'neutral',
    displayName: 'neutral',
    description: '"filter+tinted lens+friend guard+lightning rod+plus+minus"',
  },
  {
    id: 242,
    name: 'rubberboost',
    displayName: 'rubber boost',
    description: '"its stats are gradually boosted."',
  },
  {
    id: 243,
    name: 'activecurrent',
    displayName: 'active current',
    description: '"reduces a paralyzed foe\'s hp."',
  },
  {
    id: 244,
    name: 'triggered',
    displayName: 'triggered',
    description: '"cyber, virus and dark moves raise its stats."',
  },
  {
    id: 245,
    name: 'glitchboost',
    displayName: 'glitch boost',
  ...
  },
  {
    ...
    description: '"drizzle+normal becomes electric+volt absorb."',
  },
  {
    id: 247,
    name: 'flytrap',
    displayName: 'flytrap',
    description: '"restores hp if hit by a bug-type move."',
  },
  {
    id: 248,
    name: 'detonator',
    displayName: 'detonator',
    description: '"explosion moves do not kill the user, just recoil."',
  },
  {
    id: 249,
    name: 'wishmaker',
    displayName: 'wish maker',
    description: '"jirachi."',
  },
  {
    id: 250,
    name: 'burningdisease',
    displayName: 'burning disease',
    description: '"bellows+flame body+poison touch"',
  },
  {
    id: 251,
    name: 'computerbug',
    displayName: 'computer bug',
    description: '"moody+compound eyes"',
  },
  {
    id: 252,
    name: 'trashpile',
    displayName: 'trash pile',
    description: '"poison point+poison touch+stench+liquid ooze"',
  },
  {
    id: 253,
    name: 'godsendurance',
    displayName: 'gods endurance',
    description: '"cannot be defeated if its hp is above 1."',
  },
  {
    id: 254,
    name: 'souleater',
    displayName: 'soul eater',
    description: '"restores hp if hit by a ghost-type move."',
  },
  {
    id: 255,
    name: 'infected',
